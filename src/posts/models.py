...
# USING SOMETHING CALLED MVC (MODEL VIEW CONTROLLER) LOOK IT UP
...
class Post(models.Model):
    ...
    timestamp = models.DateTimeField(auto_now = False, auto_now_add = True)      # auto_now_add IS WHEN IT'S ADDED INTO DATABASE, ONLY SET 1 TIME
